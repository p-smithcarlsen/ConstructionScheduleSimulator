...
public class Client extends Application{
    ...
    public HBox addHBox() {
        ...
        Button buttonExperiment = new ButtonSchedule();
        Button buttonSimulate = new ButtonExperiment();
        Button buttonNextDay = new ButtonNextDay();
        menu.getChildren().addAll(buttonExperiment, buttonSimulate, buttonNextDay);
    
        return menu;
    }
    
    public class ButtonSchedule extends Button {
        String name;

        public ButtonSchedule() {
    ...
    public class ButtonExperiment extends Button {
        String name;
    ...
    public class ButtonNextDay extends Button {
        String name;

        public ButtonNextDay() {
            this.name = "Next Day";    
            this.setPrefSize(100, 20);
            this.setText("Next Day");
            this.setOnAction(new EventHandler<ActionEvent>() {
                public void handle(ActionEvent event) {
                    if (dayCount > 0) {
